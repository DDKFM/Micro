...
public class MicroIIUtils {
    ...
    public static JSONObject getAttributesJSON() {
		URL attributesFile = ClassLoader.getSystemResource("de/ddkfm/util/xml/Attributes.json");
		try {
			BufferedReader reader = new BufferedReader(new InputStreamReader(attributesFile.openStream()));
			String content = "";
